$(document).ready(function () {
    ...
    $("#btnclck").click(function () {
        ...
        // Convert gender identifier to a more human-readable format
        if (Gender == "1") {
            Gens = "Female";
        }
        else if (Gender == "2") {
        ...
        // Calculation for course, tuition, registration, misc, lab, totalUnits, total tuition fee for all units, and total course fees 
        var Course;
        var Tuition;
        var Registration;
        var Misc;
        ...
        var totalCourse;
        var TuitionPerUnit;
        var totalUnits = subjcts * Units; //total units based on number of subjects
        if (code === '1') {
            Course = "C1";
            Tuition = 356.75;
            Registration = 545.00;
        ...
        TuitionPerUnit = Tuition * totalUnits;//total tuition for all units
        totalCourse = TuitionPerUnit + Registration + Misc + lab;// total course fee

        // Determine the assessment type and calculate the total fee
        var balance;
        var totalFee;
        var assess;
        if (assessments == '1') {
        ...
        var ones = Math.floor(totalFee) % 10; // Calculate the ones place of the total fee
        var tens = Math.floor(totalFee / 10) % 10; // Calculate the tens place of the total fee
        var hundreds = Math.floor(totalFee / 100) % 10; // Calculate the hundreds place of the total fee
        var thousands = Math.floor(totalFee / 1000) % 10; // Calculate the thousands place of the total fee
        var tenthousands = Math.floor(totalFee / 10000) % 10;// Calculate the tenthousands place of the total fee
        var hundredthousands = Math.floor(totalFee / 100000) % 10; // Calculate the hundredthousands place of the total fee
        var cents = totalFee % 1;// Calculate the cents (decimal part) of the total fee
        var centsInteger = Math.round(cents * 100); // Convert cents to an integer
        var tenscnts = Math.floor(centsInteger / 10);// Calculate the tens place of the cents
        var rem = centsInteger % 10;// Calculate the remainder of the cents after removing the tens
        

        var centsword = "";
        var words = "";

        //for converting ones place to words
        switch (ones) {
            case 1:
                words = 'one';
                break;
        ...
        //for converting tens place to words
        switch (tens) {
            case 1:
                switch (ones) {
                    case 0:
        ...
        //for converting thousands place to words
        ...
        //for converting tenthousands place to words
        switch (tenthousands) {
            case 1:
                if (thousands == 0) {
        ...
        // Appending thousands words to the existing words
        words = thousandsWords + words;

        //for converting hundredthousands place to words
        ...
        if (tenscnts >= 2) { // Handling ones place for multiples of 10
            switch (rem) {
                case 1:
                    centsword += ' One';
                    break;
        ...
        // Handling ones place for numbers less than 10
        if (tenscnts == 0) {
            switch (rem) {
                case 1:
                    centsword = 'One';
        ...
        // Retrieve, calculation and displaying the amount tendered
       

        $('table').show()
        // Display the student information in the all-info table
        ...
        // Display the student information in the fees-info table
        ...
        if (centsword != 0) {// Display the fee amount in words
